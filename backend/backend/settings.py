...
# Asegúrate de haber instalado python-dotenv (`pip install python-dotenv`)
...
# Configuración de la base de datos usando dj-database-url para mayor flexibilidad.
# Tu .env debería tener una variable DATABASE_URL='postgres://USER:PASSWORD@HOST:PORT/NAME'
